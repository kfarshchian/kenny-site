...
import imgSyracuse from "../logos/syracuse-reverse-mortgage-utah.jpg";
import syracusesign from "../logos/syracuse-sign-reverse-mortgage-utah.jpg";
import Loader from "react-loaders";
import projectSection from "../logos/syracuse-calc-reverse-mortgage-utah.jpg";
  ...
  return (
    <>
      <ParallaxBanner
        ...
        layers={[
          { image: imgSyracuse, speed: -20 },
          { image: imgSyracuse, speed: -10 },
        ]}
      ...
      >
        ...
        >
          ...
          >
            Syracuse<br></br>Loan Officer Utah
          </h1>
        </div>
      </ParallaxBanner>
      <Container maxWidth="md">
          ...
          <div>
            ...
            >
              <p id="salt-lake-city-p">
                At Primary Residential Mortgage in Syracuse, we deeply recognize
              ...
              <p id="salt-lake-city-p">
                ...
                refinancing in Box Elder County, Utah, Kenny stands prepared to
        ...
        <p id="salt-lake-city-p">
          ...
          experience, we encourage you to reach out to Kenny Farshchian at
      ...
      <div className="reverse-mortgage-utah-home-Container-stack-img1">
        <div className="image-container">
          <img src={syracusesign} alt="reverse mortgage Utah Moving Boxes" />
        </div>
        <div id="reverse-mortgage-utah-home-text-1" className="text-container">
          ...
          <p>
            ...
            well-known and respected mortgage lender in the area reflects our
