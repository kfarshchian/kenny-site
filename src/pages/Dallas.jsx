...
import imgDallas from "../logos/dallas-city-reverse-mortgage-texas.jpg";
import dallasSign from "../logos/dallas-sign-reverse-mortgage-texas.jpg";
import Loader from "react-loaders";
import projectSection from "../logos/dallas-rate-reverse-mortgage-texas.jpg";
  ...
  return (
    <>
      <ParallaxBanner
        ...
        layers={[
          { image: imgDallas, speed: -20 },
          { image: imgDallas, speed: -10 },
        ]}
      ...
      >
        ...
        >
          ...
          >
            Dallas<br></br>Reverse Mortgage Texas
          </h1>
        </div>
      </ParallaxBanner>
      ...
      <div className="reverse-mortgage-utah-home-Container-stack-img1">
        <div className="image-container">
          <img src={dallasSign} alt="reverse mortgage Utah Moving Boxes" />
        </div>
