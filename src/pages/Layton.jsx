...
import imgLayton from "../logos/Layton-reverse-mortgage-utah.jpg";
import laytonsign from "../logos/Layton-sign-reverse-mortgage-utah.jpg";
import Loader from "react-loaders";
import projectSection from "../logos/stats-layton-reverse-mortage-utah.jpg";
  ...
  return (
    <>
      <ParallaxBanner
        ...
        layers={[
          { image: imgLayton, speed: -20 },
          { image: imgLayton, speed: -10 },
        ]}
      ...
      >
        ...
        >
          ...
          >
            Layton<br></br>Loan Officer Utah
          </h1>
        </div>
      </ParallaxBanner>
          ...
          <div>
            ...
            >
              ...
              <p id="salt-lake-city-p">
                ...
                new home. At PRMI, we wholeheartedly support you in achieving
      ...
      <div className="reverse-mortgage-utah-home-Container-stack-img1">
        <div className="image-container">
          <img src={laytonsign} alt="reverse mortgage Utah Moving Boxes" />
        </div>
        <div id="reverse-mortgage-utah-home-text-1" className="text-container">
          ...
          <br></br>
          <p>
            We take pride in being the experienced mortgage company that Layton
      ...
      <Container maxWidth="md">
        ...
        <div id="reverse-mortgage-texas-home-p">
          <p>
            When seeking a mortgage company in Layton City, look no further
        ...
        <div id="reverse-mortgage-texas-home-p">
          <p>
            ...
            ourselves to support you in every way possible. Our array of
      ...
      <div id="salt-lake-city-fourth-section">
        <Container maxWidth="md">
          ...
          <p id="salt-lake-city-p">
            ...
            the Utah loan officer who prioritizes your needs and ensures a
