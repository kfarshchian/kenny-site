...
import imgNaples from "../logos/Naples-House-sign-reverse-mortgage-florida.jpg";
import naplesSign from "../logos/Naples-sign-reverse-mortgage-florida.jpg";
import Loader from "react-loaders";
import projectSection from "../logos/Naples-approved-reverse-mortgage-florida.jpg";
  ...
  return (
    <>
      <ParallaxBanner
        ...
        layers={[
          { image: imgNaples, speed: -20 },
          { image: imgNaples, speed: -10 },
        ]}
      ...
      >
        ...
        >
          ...
          >
            Naples<br></br>Reverse Mortgage Florida
          </h1>
        </div>
      </ParallaxBanner>
      <Container maxWidth="md">
          ...
          <div>
            ...
            >
              <p id="salt-lake-city-p">
                ...
                our ability to close most loans in 23-24 days. As the trusted
                loan officer in Naples, FL, residents have come to rely on Kenny
        ...
        <p id="salt-lake-city-p">
          ...
          purchase their dream home. Contact Kenny and the team today to get
          started!
        </p>
      </Container>
      ...
      <div className="reverse-mortgage-utah-home-Container-stack-img1">
        <div className="image-container">
          <img src={naplesSign} alt="reverse mortgage Utah Moving Boxes" />
        </div>
        <div id="reverse-mortgage-utah-home-text-1" className="text-container">
          ...
          <p>
            ...
            he is the most recommended Naples loan officer! As a local loan
          ...
          <p>
            ...
            Primary Residential Mortgage Inc. is the best Naples loan officer
      ...
      <Container maxWidth="md">
        ...
        >
          ...
          <div>
            <p id="reverse-mortgage-texas-home-stack-p">
              Kenny Farshchian and his team of customer-oriented Naples, Florida
        ...
        <div id="reverse-mortgage-texas-home-p">
          <p>
            ...
            a full-service mortgage loan officer recommended by Naples, FL
      ...
      <div id="salt-lake-city-fourth-section">
        <Container maxWidth="md">
          ...
          <p id="salt-lake-city-p">
            Residents of Naples rely on Kenny Farshchian, the expert at Primary
            Residential Mortgage Inc., to secure their ideal home loans. He has
