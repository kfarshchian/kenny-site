...
import imgPalmBeach from "../logos/Palm-Beach-city-reverse-mortgage-florida.jpg";
import palmBeachSign from "../logos/palm-beach-sign-paperword-reverse-mortgage-utah.jpg.jpg";
import Loader from "react-loaders";
import projectSection from "../logos/palm-beach-approved-reverse-mortgage-florida.jpg";
  ...
  return (
    <>
      <ParallaxBanner
        ...
        layers={[
          { image: imgPalmBeach, speed: -20 },
          { image: imgPalmBeach, speed: -10 },
        ]}
      ...
      >
        ...
        >
          ...
          >
            Palm Beach<br></br>Reverse Mortgage Florida
          </h1>
        </div>
      </ParallaxBanner>
      <Container maxWidth="md">
        ...
        >
          ...
          <div>
            ...
            >
              ...
              <p id="salt-lake-city-p">
                As one of the top Palm Beach home mortgage companies, Kenny
        ...
        <p id="salt-lake-city-p">
          ...
          here to ensure that refinancing is the right decision for you. Contact
          Kenny Farshchian and his team today to explore our comprehensive range
      ...
      <div className="reverse-mortgage-utah-home-Container-stack-img1">
        <div className="image-container">
          <img src={palmBeachSign} alt="reverse mortgage Utah Moving Boxes" />
        </div>
        <div id="reverse-mortgage-utah-home-text-1" className="text-container">
          ...
          <p>
            ...
            they know the ins and outs of the local mortgage market, and can
      ...
      <Container maxWidth="md">
        ...
        >
          ...
          <div>
            <p id="reverse-mortgage-texas-home-stack-p">
              ...
              Florida mortgage loan officers are dedicated to assisting clients
        ...
        <div id="reverse-mortgage-texas-home-p">
          <p>
            ...
            Florida, that prioritizes your needs, reach out to Kenny Farshchian
            today!
          </p>
        </div>
      </Container>
